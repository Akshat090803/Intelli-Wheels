...
export const CarFilters = ({ filters }) => {
  ...
  return (
    <div className="flex lg:flex-col justify-between gap-4  ">
      ...
      <div className="lg:hidden mb-4">
        <div className="flex items-center">
          <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}   >
            ...
            >
              <SheetHeader className="border-b shadow-2xl">
              ...
              <SheetFooter className="sm:justify-between flex-row pt-2 border-t space-x-4 mt-auto ">
                ...
                <Button type="button" onClick={applyFilters} className="flex-1 cursor-pointer">
                  Show Results
                </Button>
              </SheetFooter>
            </SheetContent>
      ...
      >
        <SelectTrigger className="w-[180px] lg:w-full focus:outline-none focus-visible:ring-0">
        ...
        <SelectContent className="bg-footer/85 shadow-2xl backdrop-blur-2xl ">
          {[
            ...
            <SelectItem key={option.value} value={option.value} className="focus:bg-[#16223c]">
              {option.label}
            </SelectItem>
          ))}
        </SelectContent>
      ...
      <div className="hidden lg:block sticky top-24 ">
        <div className="border rounded-lg overflow-hidden bg-footer">
          <div className="p-4 border-b  flex justify-between items-center">
            ...
            {activeFilterCount > 0 && (
              <Button
                ...
                size="sm"
                className="h-8 text-sm text-subhead hover:bg-transparent bg-transparent"
                onClick={clearFilters}
              >
